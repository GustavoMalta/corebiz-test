      ...
      <footer className="footer">
          <div className="footer-content">
            ...
            <div className="footer-buttons">
                <Button className='footer-button' ><MdMail className='footer-button-icon' size={20}/>
                    <span>ENTRE EM CONTATO</span>
                </Button>
                <Button className='footer-button' ><MdHeadsetMic className='footer-button-icon' size={30}/>
